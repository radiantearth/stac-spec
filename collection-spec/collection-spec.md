...
| id           | string            | **REQUIRED.** Identifier for the collection that is unique across the provider. The ``/`` character is forbidden since the id value is used in some STAC API endpoints. |
