...
The `"$id"` field of the schema should be set to the filename inside of the `json-schema` directory,
e.g. `"$id": "eo-item.json#"`. The filename should be descriptive of the extension.

The layout of the schema should include references to the object it extends, as well as references
to definitions that provide the definition of the extension. For example,
