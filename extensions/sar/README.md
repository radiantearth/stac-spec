...
| description         | string    | Description to fully explain the band, should include the data type and processing information. [CommonMark 0.28](http://commonmark.org/) syntax MAY be used for rich text representation. |
