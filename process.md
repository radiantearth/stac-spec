...
The SpatioTemporal Asset Catalog specification had its v1.0.0 release on May 25, 2021. The goal is to maintain a stable
core specification that can be [extended](https://stac-extensions.github.io/) in a variety of ways.
...
The Core STAC Team is responsible for approving pull requests, and consists of anyone with write access to this repository.
...
- **Agreement from the Project Steering Committee**: The PSC should meet and decide that the release is ready.
...
For more information on the STAC PSC, see [the dedicated repository](https://github.com/radiantearth/stac-psc/).
