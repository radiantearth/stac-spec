...
| ------------------------------------------------------------ | ------------------------------------------------------------ | -------- |
| Fields | Adds parameter to constrol which fields are returned in the response. | *Pilot* |
| Query | Adds paraemter to search Item and Collection properties. | *Pilot* |
| Sort | Adds Parameter to control sorting of returns results. | *Pilot* |
