...
| Parameter    | Type             | APIs       | Description        |
| -----------  | ---------------- | ---------- | ---------------------- |
| query_profile | string | Placeholder parameter for API Query Extension query profile name (e.g., `cql`). |
| query | string or QueryFilter | Placeholder parameter for API Query Extension query value. |
...
All query languages **should** use attribute names qualified from the root of Item, rather than Item Properties.
