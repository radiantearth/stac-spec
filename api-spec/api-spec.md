...
| /stac/search  | [ItemCollection](../item-spec/README.md#itemcollection) | Retrieves a group of Items matching the provided search predicates, probably containing search metadata from the `search` extension |
