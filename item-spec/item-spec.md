...
Note: should Cloud Optimized GeoTIFF become an IANA-registered type in the future, 
this will be added as a recommended media type and `image/tiff; application=geotiff; cloud-optimized=true` will be deprecated.
