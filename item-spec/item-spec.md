...
| bbox       | \[number]                                                                  | **REQUIRED\*.** Bounding Box of the asset represented by this item, formatted according to [RFC 7946, section 5](https://tools.ietf.org/html/rfc7946#section-5). \* Note that GeoJSON allows null geometries - if a null geometry is used then the bbox is not required. |
